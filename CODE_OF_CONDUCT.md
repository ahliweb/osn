...
its issues, pull requests, and discussions), and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

> **Contact placeholder — needs a real address before publication.**
> This repository does not yet have a designated Code of Conduct contact
> address. Do not treat the placeholder below as a working contact; a
> maintainer must replace it with a real, monitored address before this
> document is relied upon for reporting.

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the community leaders responsible for enforcement at
`[CODE-OF-CONDUCT-CONTACT-NOT-YET-CONFIGURED]`. All complaints will be
